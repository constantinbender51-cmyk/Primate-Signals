...
export default function Chat() {
  ...
  useEffect(() => {
    ...
    const onChatEnded = () => {
        ...
        api.get('/api/client/chats').then(res => setChatHistory(res.data)).catch(console.error);
    }
            ...
            {chatHistory.length === 0 ? (
              ...
              <div className="space-y-3">
                {chatHistory.map(chat => (
                  <div 
                    key={chat.id} 
                    className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:border-emerald-300 transition-colors"
                  >
                    <div className="p-4">
                      ...
                      <button
                        ...
                        className="w-full py-2 px-3 bg-emerald-50 text-emerald-700 rounded-md hover:bg-emerald-100 text-sm font-medium transition-colors flex items-center justify-center"
                      >
