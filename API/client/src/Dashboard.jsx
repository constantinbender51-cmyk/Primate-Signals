...
export default function Dashboard() {
    ...
    return (
        <div>
            ...
            <div style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '1rem', textAlign: 'left', border: '1px solid #94a3b8', padding: '0.5rem', borderRadius: '4px' }}>
            ...
            {/* --- EXPLANATION --- */}
            <div style={{ marginBottom: '3rem', padding: '1rem', background: '#f8fafc', borderRadius: '8px', fontSize: '1.8rem', color: '#64748b' }}>
            ...
            <p style={{marginBottom: '3rem', textAlign: 'center'}}>
                Accuracy: <span style={{fontWeight: 'bold', fontSize: '1.8rem', color: accuracy >= 50 ? 'var(--success)' : 'var(--danger)'}}>{accuracy}%</span>
            </p>
