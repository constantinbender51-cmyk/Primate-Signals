...
export default function Dashboard() {
    ...
    const renderStrategyData = () => {
        ...
        const lines = [...(octopusData.line_prices || [])].sort((a, b) => a - b); // Sort Low to High
        ...
        if (currentPrice && lines.length > 0) {
            for (let i = 0; i < lines.length; i++) {
                if (lines[i] < currentPrice) {
                    lowerIndex = i; // Continually update to find the highest value less than price
            ...
            <div style={{ animation: 'fadeIn 0.5s ease-out' }}>
                ...
                <div style={{ 
                    ...
                    <div style={{ display: 'flex', gap: '32px', textAlign: 'right' }}>
                        <div>
                            <div style={{ fontSize: '11px', color: '#64748b', fontWeight: '700', textTransform: 'uppercase', marginBottom: '4px' }}>Dyn. Stop Loss</div>
                            <div style={{ fontSize: '20px', fontWeight: '800', color: '#dc2626' }}>{stopPct}%</div>
                        </div>
                        <div>
                            <div style={{ fontSize: '11px', color: '#64748b', fontWeight: '700', textTransform: 'uppercase', marginBottom: '4px' }}>Dyn. Take Profit</div>
                ...
                <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: '12px', padding: '24px' }}>
                    ...
                    <div style={{ 
                        ...
                        // Prompt said "List low to high". Standard list implies Top=Low. 
