                    ...
                    <tbody>
                        {currentData.map((t, i) => (
                            <tr key={i} style={{ borderBottom: '1px solid #f1f5f9' }}>
                                <td style={{ padding: '12px' }}>{new Date(t.time || t.timestamp).toLocaleDateString()} <span style={{color:'#94a3b8'}}>{new Date(t.time || t.timestamp).toLocaleTimeString([], {hour:'2-digit', minute:'2-digit'})}</span></td>
                                <td style={{ padding: '12px' }}>
                                    {t.pred_dir === 1 ? <span style={{color: '#10b981', fontWeight: '600'}}>LONG</span> : 
                                     t.pred_dir === -1 ? <span style={{color: '#dc2626', fontWeight: '600'}}>SHORT</span> : 'FLAT'}
                                </td>
                        ...
                        display: 'flex', flexWrap: 'wrap', gap: '40px', alignItems: 'center', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)'
                         ...
                         <div>
                             ...
                             <div style={{ fontSize: '24px', fontWeight: '800', marginTop: '4px' }}>
                                 {currentSignal?.pred_dir === 1 ? <span style={{color: '#059669'}}>LONG</span> : 
                                  currentSignal?.pred_dir === -1 ? <span style={{color: '#dc2626'}}>SHORT</span> : 'NEUTRAL'}
                             </div>
                         </div>
                         <div>
