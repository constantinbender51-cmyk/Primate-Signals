            ...
            try {
                ...
                results.forEach((res, index) => {
                    ...
                    if (trades.length > 0) {
                        ...
                        // This applies to both Accuracy AND Trades count on the dashboard now.
                        ...
                        // Total PnL: Sum raw pnl (from all trades including flat ones, although 0 pnl doesn't change sum)
